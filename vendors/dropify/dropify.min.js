!(function(e, i) {
  ...
  function i(i, t) {
    if (window.File && window.FileReader && window.FileList && window.Blob) {
      ...
      (this.element = i), (this.input = e(
        this.element
      )), (this.wrapper = null), (this.preview = null), (this.filenameWrapper = null), (this.settings = e.extend(
        !0,
        s,
        t,
        this.input.data()
      )), (this.errorsEvent = e.Event(
        "dropify.errors"
      )), (this.isDisabled = !1), (this.isInit = !1), (this.file = {
        object: null,
        name: null,
        size: null,
        width: null,
        ...
        this
      )), (this.clearElement = this.clearElement.bind(
        this
      )), (this.onFileReady = this.onFileReady.bind(
        this
      )), this.translateMessages(), this.createElements(), this.setContainerSize(), (this.errorsEvent.errors = []), this.input.on(
        "change",
        this.onChange
      );
    }
  ...
  return (i.prototype.onChange = function() {
    ...
    e(this.settings.tpl.errorLine).appendTo(i), this.isTouchDevice() === !0 &&
      ...
      ((this.isDisabled = !0), this.wrapper.addClass("disabled")), this.settings
      .showLoader === !0 &&
      (
        (this.loader = e(this.settings.tpl.loader)),
        this.loader.insertBefore(this.input)
      ), (this.preview = e(
      this.settings.tpl.preview
    )), this.preview.insertAfter(this.input), this.isDisabled === !1 &&
      this.settings.showRemove === !0 &&
      (
        (this.clearButton = e(this.settings.tpl.clearButton)),
        this.clearButton.insertAfter(this.input),
        this.clearButton.on("click", this.clearElement)
      ), (this.filenameWrapper = e(
      this.settings.tpl.filename
    ...
    if (i.files && i.files[0]) {
      ...
      this.clearErrors(), this.showLoader(), this.setFileInformations(
        r
      ), (this.errorsEvent.errors = []), this.checkFileSize(), this.isFileExtensionAllowed(), this.isImage() &&
      this.file.size < this.sizeToByte(this.settings.maxFileSizePreview)
        ? (
            this.input.on("dropify.fileReady", this.onFileReady),
            t.readAsDataURL(r),
            (t.onload = function(e) {
              (n = e.target.result), (s.src =
                e.target.result), (s.onload = function() {
                o.setFileDimensions(
                  this.width,
                  this.height
                ), o.validateImage(), o.input.trigger(h, [!0, n]);
              });
            }.bind(this))
          )
        : this.onFileReady(!1);
    ...
    if (
      ...
      this.wrapper.addClass(
        "has-error"
      ), this.resetPreview(), this.clearElement();
    }
  }), (i.prototype.setFileInformations = function(e) {
    (this.file.object = e), (this.file.name = e.name), (this.file.size =
      e.size), (this.file.type =
      e.type), (this.file.width = null), (this.file.height = null);
  }), (i.prototype.setFileDimensions = function(e, i) {
    (this.file.width = e), (this.file.height = i);
  }), (i.prototype.setPreview = function(i, t) {
    this.wrapper
      .removeClass("has-error")
      .addClass("has-preview"), this.filenameWrapper
    ...
    if ((this.hideLoader(), i === !0)) {
      ...
      this.settings.height &&
        r.css("max-height", this.settings.height), r.appendTo(s);
    } else
    ...
    e.find(".dropify-extension").remove(), e.find("i").remove(), e
      .find("img")
      .remove(), this.preview.hide(), this.hideLoader();
    ...
    0 !== this.settings.minWidth &&
      ...
      this.pushError("maxWidth"), 0 !== this.settings.minHeight &&
      this.settings.minHeight >= this.file.height &&
      this.pushError("minHeight"), 0 !== this.settings.maxHeight &&
    ...
    return this.file.width == this.file.height
      ...
      : this.file.width < this.file.height
        ? "portrait"
        : this.file.width > this.file.height ? "landscape" : void 0;
          ...
          : "minHeight" === e
            ...
            : "maxHeight" === e
              ...
              : "imageFormat" === e
                ...
                : "fileExtension" === e &&
                  (t = this.settings.allowedFileExtensions.join(", ")), "" !== t
      ? i.replace("{{ value }}", t)
      : i;
