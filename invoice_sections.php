        ...
        <div class="content-wrapper">
          <div class="card">
            <div class="card-body">
              ...
              <h4 class="card-title">أقسام الفواتير</h4>
              <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter">
               اضافة قسم جديد للفواتير
                </button>
                <!-- Modal -->
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form class="forms-sample" method="POST" action="insert/section.php">
              ...
              <div class="modal fade" id="editModalCenter" tabindex="-1" role="dialog"
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form class="forms-sample" method="POST" action="update/invoice_section.php">
                          <div class="form-group">
                            <label>عنوان القسم</label>
              ...
              <div class="row">
                <div class="col-12">
                  <table id="order-listing" class="table" style="overflow-x:scroll">
                    ...
                    <tbody>
                    <?php
                    $ret = mysqli_query($con, "select * from sections ORDER BY id DESC");
                    $cnt = 1;
